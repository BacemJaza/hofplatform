...
export function TopBar() {
  return (
    <div
      className="mx-auto mt-5 mb-5 max-w-[1200px] py-2"
      style={{ ["--topbar-height" as any]: "56px" }}
    >
        <div className="flex flex-col items-center gap-3 md:items-center w-auto">
            <div className="flex flex-row gap-10 justify-end">
                <a href="mailto:houseofflagstn@gmail.com" className="flex items-center gap-2 rounded-sm border px-3 py-2 text-xs transition hover:bg-foreground hover:text-background">
                ...
                <a href="tel:+21653069199" className="flex items-center gap-2 rounded-sm border px-3 py-2 text-xs transition hover:bg-foreground hover:text-background">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-3 w-3">
                ...
                <a href="https://www.instagram.com/houseofflagstn" target="_blank" rel="noreferrer" className="flex items-center gap-2 rounded-sm border px-3 py-2 text-xs transition hover:bg-foreground hover:text-background">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-3 w-3">
