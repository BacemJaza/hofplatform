...
const dicts: Record<Lang, Dict> = {
  en: {
    ...
    "banner.line1": "A different way to decorate.",
    ...
    "drop.title": "DROP 001",
    "drop.intro":
      "Pieces live now. Printed on heavyweight cotton flag fabric. Made in limited quantity. When the count hits zero, it stays zero.",
  ...
  fr: {
    ...
    "drop.title": "DROP 001",
    "drop.intro":
      "Les pièces en direct. Imprimée sur un tissu drapeau coton épais. Fabriquée en quantité limitée. Quand le compteur atteint zéro, il y reste.",
