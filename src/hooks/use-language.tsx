...
const dicts: Record<Lang, Dict> = {
  ...
  ar: {
    ...
    "nav.drops": "الإصدارات",
    "nav.cart": "السلة",
    "hero.tag": "خلطة — الإصدار 001 / متوفر الآن",
    ...
    "philosophy.body":
      "خلطة — تبنات في تونس للي ما حبّوش براويز متشابهة. كل راية هي قطعة قماش تعني حاجة — ليك، للي يدخل بيتك، وللنسخة منك اللي علّقتها.",
    ...
    "bag.remove": "حذف",
    "footer.tag": "خلطة — فن القماش من تونس. إصدارات محدودة. لا إعادة تزويد.",
    "footer.index": "الفهرس",
    "footer.follow": "تابعنا",
    "footer.rights": "© خلطة — تونس. كل الرايات محفوظة.",
    "footer.made": "مصنوعة للي يعلّقو هويّتهم. خلطة.",
  },
};
